...
public class UrbanSashForm extends Composite {
     ...
     * @see #getStyle()
     */
    public UrbanSashForm( Composite parent, int style) {
     ...
     *                or of incorrect length (must match the number of children)</li>
     *                </ul>
     */
    public void setWeights( int[] weights){
        ...
        for (int i = 0; i < cArray.length; i++) {
            ...
            ((SashFormData) data).weight = (((long) weights[i] << 16) + total - 1)
                    / total;
        }
